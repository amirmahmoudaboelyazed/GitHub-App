...
FilterChipData  filterChipDataFromJson(String  str) => FilterChipData.fromJson(json.decode(str));

String  filterChipDataToJson(FilterChipData  data) => json.encode(data.toJson());
...
class FilterChipData {
  ...
  factory FilterChipData.fromJson(Map<String , dynamic>  json) => FilterChipData(
